...
# annotation. This 40-word display limit is independent of the retired session
# prose targets (scripts/README.md#gate-composition-and-admission).
# Full annotation stays on the ADR; A1/A2 still parse the unclipped header.
...
> Notes cells display at most 40 words; the full Status annotation lives on the ADR.
"""
