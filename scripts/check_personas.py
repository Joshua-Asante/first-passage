...
EXPECTED_COUNT = 9  # 17 as of 2026-08-20 (see docs/adr/2026-08-19-loop-persona-hierarchy-review-panel.md
# change history for that count's own lineage). Narrowed to Front-Office-only (+ CEO apex, CFO
# cross-office) 2026-08-21: six Middle/Back-office C-suite/Senior-Manager seats (CRO, Head of Risk &
# Sizing, Head of Validation, COO, Head of Engineering, Head of Governance) plus their two
# Back-office Staff (Documentation Analyst, Research Registry Analyst) retired to mechanical gates
# and moved to docs/personas/archive/ -- see
# docs/adr/2026-08-21-persona-hierarchy-front-office-only.md §2 D1/D2. 17 - 8 = 9.
