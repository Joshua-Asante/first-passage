...
Long breakout strategy on NAS100 (NASDAQ 100) 15min. Pine Script v6. Architecture-family sibling of Striker DJ30 v4.5 — shares entry filters, exit logic, and adaptive trail, but instrument-tuned (0.37% risk per 2026-05-23 allocation-refresh-2, 1000% pyramid, Mon+Tue only).
...
Same 4-strategy stack at C0 (1.0%/0.40×): 97.88% pass / 0.22% bust / p99 DD 4.55%, median days-to-pass 23. Bust attribution: DJ30 40.9% / G 25.8% / A 22.7% / NAS 10.6%. See `archive/docs/briefs/striker_nas100_q_nas_3_mc_addition.md` for the addition decision audit.
