...
| 9 | "Composite clearance forbidden" rule | UNRATIFIED-OR-UNWIRED | **REFUTED, 3/3.** Founding artifact exists one level up (`docs/briefs/programs/2026-08-13-msl-second-slate.md:48`, predates and parents STAGE0/STAGE1); the rule composes two independently-ratified closures, not an invented ad hoc bar. |
