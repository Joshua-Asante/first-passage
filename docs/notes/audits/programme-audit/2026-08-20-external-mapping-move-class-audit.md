...
4. **Consolidate the two sharpened guardrails into one canonical location.** They currently live embedded inside two separate Notice bodies (instances 2 and 3); a fourth instance, if ever GO'd, would need to re-read both in full to inherit them rather than citing one place. No placement decision is made here — named, not opened, per this repo's standing convention for un-GO'd work. **Owner: operator (placement call). Due: n/a until GO'd.** **Discharged 2026-08-23:** [`docs/methodology/external_mapping_guardrails.md`](../../../methodology/external_mapping_guardrails.md) — consolidation, not a sixth belt add. Instance 4 GO: [`N-2026-08-23-nemo-guardrails-reconciliation.md`](../../notice/N-2026-08-23-nemo-guardrails-reconciliation.md). The standing pin / Proposed ADR from that GO was later rejected; the GO record and this consolidation stay.
