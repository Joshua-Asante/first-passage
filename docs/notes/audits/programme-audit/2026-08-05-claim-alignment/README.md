...
**One boundary was crossed deliberately** (FU-1's token-trade ruling, §5) — named as a crossing, reasoned, bounded to one operator-placed trade in one named week, and recorded at both sites where the constraint is read. Under this protocol that is the system working; the protocol's concern is *silent* crossing. **Four erosion tests are pre-registered** in [`01-diagnostics.md`](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/docs/notes/audits/programme-audit/2026-08-05-claim-alignment/01-diagnostics.md) §3.5 so the next audit can test the claim rather than re-argue it.
...
**Intervention is required, not optional.** [`07-followups.md`](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/docs/notes/audits/programme-audit/2026-08-05-claim-alignment/07-followups.md) rows **FU-5, FU-6, FU-7, FU-8, FU-12, FU-13** — plus round-2 additions **FU-17** and **FU-18** — are the mandatory outputs of this verdict, each naming the limb it discharges. **FU-8 is the only one that stops recurrence rather than repairing damage.**
