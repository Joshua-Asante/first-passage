...
| **M6** | [`docs/briefs/programs/2026-07-12-08-08-packet-pretriage.md`](../../briefs/programs/2026-07-12-08-08-packet-pretriage.md) L34 body | Still states “`ACTIVE_FIRM` stays FXIFY” / rail gated | Banner at top already marks superseded; body unedited | **Leave** if banner is load-bearing; optional body footnote. Prefer agents read banner |
...
| **L5** | [`docs/briefs/programs/2026-07-14-b3-multiplier-spine-forward-relevance-disposition.md`](../../briefs/programs/2026-07-14-b3-multiplier-spine-forward-relevance-disposition.md) | KEEP-dormant / do not delete `calc_multiplier` | Phase 2 **deleted** the spine | **Banner** “superseded by substrate §2-D” |
