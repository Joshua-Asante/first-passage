...
Per `archive/docs/methodology/archive/analysis/notice_phase/findings.md`:
...
deleted in the same compression. Regenerable from `archive/docs/methodology/archive/analysis/notice_phase/notice_phase.py`.
...
- Repo: `archive/docs/methodology/archive/analysis/notice_phase/findings.md` (evicted 2026-06-05; retrieve via `git show pre-prune-2026-06-05:archive/docs/methodology/archive/analysis/notice_phase/findings.md`) — first application of the gate.
