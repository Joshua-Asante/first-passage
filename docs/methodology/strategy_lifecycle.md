...
- **`CANDIDATE` Call-1 breach → not autonomous demotion** (Proposed, awaiting Accept): no reversible rung below AUTHORIZED is coded; mandated action is operator review flag only — [`docs/adr/2026-08-06-candidate-call1-action-on-breach.md`](../adr/2026-08-06-candidate-call1-action-on-breach.md).
