...
This composes with the observation-routing gate (§10) rather than competing: Closed / Action / Forward routes *observations* between decision points; INTEGRATE / ITERATE / STOP routes *closure verdicts* at the loop exit, pre-registered per verdict in the brief's §6.
