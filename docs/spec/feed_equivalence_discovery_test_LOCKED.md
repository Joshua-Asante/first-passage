...
- **F4 — MC anchor drift.** The "Pass 97.88% / Bust 0.22% / p99 DD 4.55%" anchor cited in §Context was superseded on 2026-05-08 by the C2 relock (ADR `2026-05-08-dd-trigger-c2-relock`). Current anchor: **Pass 98.09 / Bust 0.36 / p99 DD 4.73, attribution striker 44.4 / aegis 24.1 / G 21.3 / NAS 10.2.** The test design is unchanged; only the anchor numbers that the test's "MC transfers as-is" branch licenses transferring have moved. See §Outcome bridge for explicit current-anchor handling. _(Update 2026-06-08: further superseded by the 2026-05-14 / 2026-05-23 allocation refreshes; the current headline anchor is **Pass 99.83 / Bust 0.17 / p99 DD 4.37** per CLAUDE.md and `docs/mc_anchor_history.md`. The 98.09/0.36/4.73 figure is the 2026-05-10 snapshot, kept for audit; the "transfers whichever anchor is current" rule is unchanged.)_
