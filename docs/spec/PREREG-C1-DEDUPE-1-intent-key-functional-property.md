...
> **Pointer re-home 2026-09-12 (TB-O1; cross-references only — the pre-registered design, falsifier and gate above are byte-unedited):** the three `docs/notes/rail_build/` links in the first bullet name private files excluded from the public tree by the [public-visibility ADR](../adr/2026-08-14-repo-public-visibility-transition.md). Retrieve them per [`ARMING_PROCEDURE.md`](../notes/rail_build/ARMING_PROCEDURE.md) §2 — archive pin `5d47b4dc…`: [RUNBOOK.md](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/docs/notes/rail_build/RUNBOOK.md) · [make_payload.py](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/docs/notes/rail_build/b4_dry_fire_payloads/make_payload.py) · [B7_STAGE1_DESK_CARD_2026-07-31.md](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/docs/notes/rail_build/B7_STAGE1_DESK_CARD_2026-07-31.md) — or from the primary checkout's ignored private root. The public arm/disarm procedure that this pre-registration's §6 gate (M1 `RESOLVED` + operator GO) feeds is that same file; nothing here is rescheduled or released.
