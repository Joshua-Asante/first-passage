...
- **F5 — ToS re-verification:** Tradeify FTA §6.6 / MFFU article 8444599 re-fetched fresh (90-day rule; deployment-fork re-verify) with automation posture unchanged. **SCORED 2026-07-17: `PASS`** — posture unchanged at both firms ([`PHASE0.md`](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/lab/analysis/c1/q_rail_1_2026-07/PHASE0.md)).
