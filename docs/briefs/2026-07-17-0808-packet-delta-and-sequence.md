...
**Status:** `DRAFT (operator review owed)` — updates the **RATIFIED** pre-triage; records
...
rg -n "2026-07-12-08-08-packet-pretriage" docs/briefs/2026-07-17-0808-packet-delta-and-sequence.md
...
rg -n "OPERATOR 2026-07-23|ORB-MNQ remains PARKED|UNPARKED 2026-07-31|re-PARKED 2026-08-03|VERIFIED 2026-08-03" \
  docs/briefs/2026-07-17-0808-packet-delta-and-sequence.md
...
rg -n "RETIRED|time_to_pass" docs/briefs/2026-07-17-0808-packet-delta-and-sequence.md

# A5 honesty + Q-EVALSEQ on the slate
rg -n "NOT_EXECUTABLE|Q-EVALSEQ-1" docs/briefs/2026-07-17-0808-packet-delta-and-sequence.md
...
ls docs/briefs/2026-07-23-tradeify-book-composition.md \
...
```bash
python3 scripts/check_brief.py docs/briefs/2026-07-17-0808-packet-delta-and-sequence.md --type generic
git log -1 --format='%h %cs' -- docs/briefs/2026-07-12-08-08-packet-pretriage.md
```
