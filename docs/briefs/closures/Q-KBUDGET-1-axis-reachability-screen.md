...
Reproduced in full in the pre-reg §E annex (filled 2026-07-14) and [`RESULTS.md`](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/lab/archive/q_kbudget_1_2026-07/RESULTS.md). Which clause killed each excluded axis:
