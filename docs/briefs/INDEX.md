...
| **Q-RANGEXFER-1** — does MNQ overnight-range / gap-magnitude carry genuine same-day RTH-range information beyond a shared-regime confound (D5 "S2" cross-series shape); forks Q-RANGEXFER-1.a (gap, nested to the overnight-calm stratum) | **`OPEN`** 2026-08-29 — D5 stage-1 $0 falsifier + joint D-S-A gate both run and clear; Phase 1 (joint-surrogation null design, D5's own O1 `UNRESOLVED-NEEDS-DESIGN` item) needs operator GO before it starts | [`Q-RANGEXFER-1-overnight-range-gap-magnitude-transfer.md`](Q-RANGEXFER-1-overnight-range-gap-magnitude-transfer.md) · [pre-reg](pre-registration/Q-RANGEXFER-1-verdict-preregistration.md) · [joint gate](../../lab/analysis/_inbox/mnq_dailygeom_notice_2026-08-29/candidate24_joint_gate.py) | Operator GO for Phase 1 design work, then adversarial review of that design (§7 Phase 2) before any execution. |
