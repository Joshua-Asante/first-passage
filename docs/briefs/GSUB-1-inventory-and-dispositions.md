...
| d1 repo belt · d2 brief-authoring(user) · d3 rule-0 | **KEEP** (×3) | Serves A4, actively consumed; d2 residual assigned: checker-canon split → **operator one-line ruling** (later, not this run) — ⚠ Correction 2026-08-31: ruled same day, see [`docs/adr/2026-08-09-check-brief-canon-ruling.md`](../adr/2026-08-09-check-brief-canon-ruling.md) (Accepted 2026-08-09, Gate: RESOLVED) |
