...
**Status:** `CLOSED — FALSIFIED-NONPROPORTIONAL` (2026-07-17) — Phase 0–3 complete; [`closure`](closures/Q-PYRPARITY-1-closure-falsified-nonproportional.md) · [`RESULTS`](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/lab/archive/q_pyrparity_1_2026-07/RESULTS.md). WATCH-1 for pyramided legs → account-multiplier-layer fallback; Q-RAIL-1 F1 = PASS-via-fallback.
**Authored:** 2026-07-17
**Closed:** 2026-07-17
...
- **Phase 2 — mechanical verification. ✅ DONE 2026-07-17** — Branch B harness `verify_phase2.py`; [`RESULTS.md`](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/lab/archive/q_pyrparity_1_2026-07/RESULTS.md). **Overall `FALSIFIED-NONPROPORTIONAL`** (MYM medians 0.871 / 0.916 — binding TV qty ceiling at 17/127; below ceiling ratios ≈ 0.50). MNQ leg `AMBIGUOUS-HOLD` (list misalignment + base integer-rounding fill-frac).
