...
| Governing contract | this dispatch (rev 4: Codex review on #358 folded — distinct artifacts, working orders, zero adjustments, `valid_until`, capture≤seal, output≠evidence) | fields, evidence files, checks C1–C10, output, boundary |
