# Operator card — MSL-C2 explore GO (**ISSUED → FALSIFIED**)
...
Long n=327 mean **−0.179R** CI [−0.287, −0.071] · Short n=310 mean **−0.182R** CI [−0.292, −0.075] · DELETE FAIL both · FLIP PASS (moot).

## Disposition

**STOP** this G0. Slate hands slot to **P3.2 MSL-C3 (M2K)** — Stage-0 L3 one-shot + WSTRUCT sequencing before flight.
