...
- **Phase 1 — Fan-out.** **DONE 2026-07-16** — Tier-1/Tier-2 fan-out under Q1–Q6; artifacts in [`lab/analysis/harvest/q_kbudget_harvest_1_2026-07/`](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/lab/analysis/harvest/q_kbudget_harvest_1_2026-07/README.md). Two four-field-complete candidates after Fig. 2 scrape (`H-OD-1`, `H-TSMOM-1`); E.1 seeds logged. Zero pulls. Zero K.
...
- **Phase 3 — Extend floor scan.** **DONE 2026-07-16** — append-only H1/H2 in `floor_scan.py`; `phase3_screen_manifest.json` + `axis_screen` → 6 FAIL / 3 PASS; [`PHASE3_RESULTS.md`](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/lab/analysis/harvest/q_kbudget_harvest_1_2026-07/PHASE3_RESULTS.md); §6 **RESOLVED**; closure written; STATE updated.
