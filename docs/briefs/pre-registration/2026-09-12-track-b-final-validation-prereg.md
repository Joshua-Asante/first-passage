...
**Status:** DRAFT · 2026-09-12 · packet TB-P1 of the [Track B umbrella](../handoffs/2026-09-10-track-b-qualify-accepted-book-umbrella.md) · **nothing here is frozen** — every field marked `OWED-BY: TB-F1` is filled and frozen only by TB-F1 after wave 2 merges, TB-C1 merges and the [TB-P2 admission ADR](https://github.com/Joshua-Asante/first-passage/pull/361) is ratified · authorizes nothing ($0 · K=0)
...
**Companion drafts:** [ORB R2 supersession skeleton](../../adr/2026-09-12-orb-mnq-r2-supersession-DRAFT.md) · [TB-S2 replay spec](../../spec/2026-09-12-tradeify-synchronized-replay-spec.md) · [TB-S3 rail spec](https://github.com/Joshua-Asante/first-passage/pull/360) · [snapshot-seal contract](../../spec/2026-09-12-tradeify-account-snapshot-seal-contract.md) · [TB-R2 read](../../notes/2026-09-12-track-b-scaling-faithfulness-read.md)
...
The normative FBR/EF composition, normalization and EF1→EF2 GO-only reseal are [TB-P2 §2a–§2b](https://github.com/Joshua-Asante/first-passage/pull/361). The summaries below cannot omit those requirements; the ADR remains proposed until its operator ratifications.
