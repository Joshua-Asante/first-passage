...
| 6 | `docs/briefs/programs/2026-07-23-tradeify-book-composition.md` @ `a68aadc` | 2-leg anchors: 63% eval pass / 8.2-mo median / 1.00 winning day-mo / $339 chain; funded start tier 40 micros until EOD ≥ $103,000 | Read §0–§7 + §10. Rule pins §0 carry three ⚠ secondary-sourced items (winning-day $200, funded start tier, Flex min payout) — **unresolved, and they bind this brief's funded-phase arm** (see §5 and §6 AMBIGUOUS). |
