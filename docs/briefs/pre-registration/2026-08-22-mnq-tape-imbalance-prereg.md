...
**Route:** [Avenue A §6](../programs/2026-07-24-avenue-a-microstructure-scoping.md) **Route B
...
| [`docs/briefs/programs/2026-07-24-avenue-a-microstructure-scoping.md`](../programs/2026-07-24-avenue-a-microstructure-scoping.md) | `027a729` | Qualifying-triple origin (depth-shape-or-equivalent, not fill-trivial, survivor-tie-or-Route-B); the standing rule this whole campaign exists to satisfy: **"don't buy explanatory data before a survivor justifies it"** |
| [`docs/briefs/programs/2026-07-14-a4-flow-data-fork-scoping.md`](../programs/2026-07-14-a4-flow-data-fork-scoping.md) | `027a729` | a4 kills **participant-category** splitting (net imbalance only, can't split who's trading) — does **not** reach aggressor-side (tick/quote-rule) classification, a different, fully identifiable object |
...
| [`docs/briefs/programs/2026-07-27-f1-moc-imbalance-mym-ruling.md`](../programs/2026-07-27-f1-moc-imbalance-mym-ruling.md) | `027a729` | F1 (MOC-imbalance on MYM) cleared **no** route and was `FALSIFIED — reject-at-bar` at the paid-data procurement gate — but F1 was ruled 2026-07-27, **ten days before** Route B existed (`Accepted` 2026-08-05). This campaign clears a route F1 could not have used; F1's kill does not transfer |
