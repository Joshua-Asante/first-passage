...
# Expected: gap lift +0.105 (overnight-stratum=0, bootstrap p=0.0078 / null-calibrated p=0.0060)
#           / -0.081 (overnight-stratum=1, bootstrap p=0.998 / null-calibrated p=0.983);
# overnight lift +0.594 (gap-stratum=0, both p=0.00025) / +0.407 (gap-stratum=1, both p=0.00025)
