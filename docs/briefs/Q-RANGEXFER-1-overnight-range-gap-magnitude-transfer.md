...
**Status:** `OPEN`
**Authored:** 2026-08-29
**Amended:** 2026-08-30 — scope broadened from MNQ-only to MNQ+MYM, per `N-2026-08-29-mym-overnight-gap-joint-gate.md`'s recommendation (§4: "this lands as a PR for review; the merge/no-merge call and its execution belong to that review") — this amendment IS that review, executed as a reviewed PR per that notice's own instruction rather than self-executed as a side effect. Amended again same day (composite-null correction, PR #211 — new `H-RANGEXFER-1.b-MYM` clause added). See §11 Amendment log.
**Closed:** N/A
