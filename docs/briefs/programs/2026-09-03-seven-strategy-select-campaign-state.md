...
⚠ **A derived percentage that inverts back to a redacted figure is the same disclosure.** The "3.2% shorter
run to target" reconstructed the balance to the cent from the public $6,000 target. It is redacted too, and
