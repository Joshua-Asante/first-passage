...
Branch codex/tradeify-phase1-population from current origin/main. One PR; no rebase, no force-push, no merge — the operator merges. Orchestrator surfaces (STATE.md, docs/SESSIONS.md, any campaign artifact, ADRs, the plan) are off-limits; so are Pine, core/, and vendor bytes.
...
§47b as amended nine times is canonical.
