...
diff /tmp/ext.bak core/data/external/SHA256SUMS && diff /tmp/cme.bak core/data/tv_exports/cme/SHA256SUMS \
  || { echo "UNRELATED MANIFEST CHANGED — restore from the .bak copies before committing"; }
