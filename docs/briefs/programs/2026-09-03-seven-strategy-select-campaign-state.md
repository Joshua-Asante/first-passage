...
NEVER: paste an override value anywhere (chat transcript, commit, PR, tracked file, screenshot); force-add anything under inputs/; widen a tolerance; edit Pine, core/, STATE.md, docs/SESSIONS.md, ADRs or any campaign artifact; open or commit vendor bytes; merge.
```
