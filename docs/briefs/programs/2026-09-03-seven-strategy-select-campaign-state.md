...
| 3 | **DJ30 +$287.00** reconciled or explicitly dispositioned | owed — **sharpened, not closed** (§18c): now panel-vs-panel, so not a capture artifact; the whole delta is on the **loss** side |
| 4 | Four bar-panel hashes | ✅ accepted (this section) |
| 5 | §14e generation on `main` | ✅ merged (§16g) |

Until 1 and 3 clear, `phase1_verdict_cap` stays `NEEDS_CONTEXT`, every strategy stays `BLOCKED_EXPLORATORY`, and
