...
rg -n "don't buy explanatory data before a survivor" docs/rejected_candidates.md docs/briefs/2026-07-24-avenue-a-microstructure-scoping.md

# Avenue A must still be scoped-not-procured (if this flips, re-read this ruling)
rg -n "scoped-not-procured|stays scoped" docs/briefs/2026-07-24-avenue-a-microstructure-scoping.md
...
test -f docs/briefs/2026-07-27-f1-moc-imbalance-mym-ruling.md && echo AUTHORITATIVE_OK
