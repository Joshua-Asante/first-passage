...
NEEDS_CONTEXT` on #283 @ `809bbb4` (merged by the operator at `39530d4` before the re-anchor round; follow-up Codex PR pending); operator rules D10 (ii) (swap-port chart inputs), D11 (re-express or drop the
