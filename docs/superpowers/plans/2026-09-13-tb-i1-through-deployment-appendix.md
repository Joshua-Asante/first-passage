> **Companion appendix:** The [active four-stage plan](2026-09-13-tb-i1-through-deployment.md) owns current delivery status and the prerequisites ledger. This appendix preserves the original detailed requirements and dated execution records from commit `2c72294`. Historical statements about what had started or remained open describe their recording time. Task numbers below are stable requirement references, not separate mandatory delivery packets. Unfinished technical requirements remain binding; no gate is waived by regrouping them. Future status updates belong in the active plan and reference evidence rather than duplicating this history.
...
The [current release ledger and concrete decision text](https://github.com/Joshua-Asante/first-passage/blob/d620602e0bc2e247f0e5513558eb512aa50c13ed/docs/briefs/handoffs/2026-09-13-tradeify-contract-closeout.md#current-tb-i1-first-slice-reconciliation--2026-09-13) identify the still-pending S3/P2 ratifications and incomplete unified schedule. Checked boxes above mean reconciliation/preparation was performed, not that Joshua approved the proposal. Task 1's ratification entry remains open, and Tasks 2–5 have not started. Exact Part A depth remains a later F1/E1 decision.
