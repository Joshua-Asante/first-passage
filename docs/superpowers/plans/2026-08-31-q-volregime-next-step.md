...
>
> **Status:** `AWAITING GO` — drafted 2026-08-31 at operator request. Drafting
> this plan does not authorize research execution, does not declare K, and does
> not change either instrument's verdict. The 2026-08-30 GO covered the Phase-1
> design work recorded in the parent brief; this plan proposes an amendment to
> that design route because its intended day-level parent failed validation.
>
...
- [ ] **A1 — Re-read owners and verify the input bytes.**
...
- [ ] **A2 — Write the L3 test before printing results.**
