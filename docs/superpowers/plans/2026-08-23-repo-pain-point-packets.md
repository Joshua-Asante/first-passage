...
| Personas / dual agent surfaces | Parked — operating model (unchanged). ⚠ **Stale (corrected 2026-08-31).** Personas are fully retired, not "unchanged" — [persona-hierarchy-full-retirement ADR](https://github.com/Joshua-Asante/first-passage/blob/4fb2b88f3b7d56d77463c43ba45c87ffadff6a31/docs/adr/2026-08-31-persona-hierarchy-full-retirement.md); dual agent surfaces are unaffected |
...
| Personas / dual skill homes / two venvs | operating model. ⚠ **Stale (corrected 2026-08-31).** Persona hierarchy fully retired — [persona-hierarchy-full-retirement ADR](https://github.com/Joshua-Asante/first-passage/blob/4fb2b88f3b7d56d77463c43ba45c87ffadff6a31/docs/adr/2026-08-31-persona-hierarchy-full-retirement.md); dual skill homes/venvs unaffected | leave |
