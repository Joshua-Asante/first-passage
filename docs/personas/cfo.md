...
**Reports-to:** CEO
**Spawned:** Yes
**Domain:** The Survive bound (<=5 queue cap -- concurrency-denominated per `docs/adr/2026-08-09-survive-bound-is-the-queue-cap.md`; not itself a capital concept, despite sitting in this seat's domain), subscription spend (d11-d17), capital-allocation rulings (F1) (⚠ Correction 2026-08-31: F1 was ruled 2026-08-23 -- a Tradeify-resting discharge does not satisfy §4, see `docs/adr/2026-08-04-tradeify-venue-descope-eval-included.md` §7 Addendum 2026-08-23; kept here as a domain example, not a live open item), and the weekly token-trade compliance obligation.
