# MC anchor evolution — 2026-04-17 → 2026-05-23

> **ARCHIVE NOTE (2026-06-24)** — the OANDA cross-feed is retired ([`docs/adr/2026-06-24-oanda-retirement.md`](../../adr/2026-06-24-oanda-retirement.md)). The OANDA overlay below is **frozen at its 5 historical anchors (2026-05-05 → 2026-05-24)**; no new OANDA anchors will be added. `plot.py` / `data.csv` and the OANDA chart-guard tests remain as a historical record.

Nine-anchor trajectory of the production portfolio MC lock anchor, with
OANDA pattern-spotting overlay where exports exist (frozen historical). Every number is
...
| A2 | 2026-04-23 | Pepperstone migration + Guardian risk re-lock 0.30 → 0.34 (committed-panel replay; 3-strat S v4.4 / A v4.3) | 93.78% | 0.58% | 4.92% | 32 | +0.78 pp | −0.97 pp | +0.02 pp | [ADR 2026-04-23 Guardian re-lock 0.34](../../adr/2026-04-23-guardian-risk-relock-0.34.md) + `bust_attribution_flip.md` §Partial-D's (evicted 2026-06-05; retrieve via `git show pre-prune-2026-06-05:archive/docs/briefs/bust_attribution_flip.md`) |
| A3 | 2026-05-05 | 4-strategy addition at C0 (DJ30 v4.5 + NAS100 v1 0.40%) — **pre-reconcile transient, 209-trade Guardian** | 98.13% | 0.22% | 4.49% | — | +4.35 pp | −0.36 pp | −0.43 pp | `striker_nas100_q_nas_3_mc_addition.md` §Re-anchor note (evicted 2026-06-05; retrieve via `git show pre-prune-2026-06-05:archive/docs/briefs/striker_nas100_q_nas_3_mc_addition.md`) — superseded same day by A4 |
| A4 | 2026-05-05 | 4-strategy addition at C0 — **post-reconcile**, 201-trade Guardian (8 phantom v5.5 signals removed) | 97.88% | 0.22% | 4.55% | 23 | −0.25 pp | 0.00 pp | +0.06 pp | `striker_nas100_q_nas_3_mc_addition.md` (evicted 2026-06-05; retrieve via `git show pre-prune-2026-06-05:archive/docs/briefs/striker_nas100_q_nas_3_mc_addition.md`) + `Q-DDP-1/sweep_results.csv` §C0 (evicted 2026-06-05; retrieve via `git show pre-prune-2026-06-05:archive/docs/briefs/Q-DDP-1/sweep_results.csv`) + `tests/core/test_mc_anchors.py` (pre-05-08 pin) |
| A5 | 2026-05-08 | dd_protection C2 relock — DD_TRIGGER 0.010 → 0.015 (DD_SCALE held at 0.40), 2022→2026 all-data panel | 98.09% | 0.36% | 4.73% | 22 | +0.21 pp | +0.14 pp | +0.18 pp | [ADR 2026-05-08 C2 relock](../../adr/2026-05-08-dd-trigger-c2-relock.md) + `tests/core/test_mc_anchors.py` (pre-2026-05-14 pin) + `Q-DDP-1/sweep_results.csv` §C2 (evicted 2026-06-05; retrieve via `git show pre-prune-2026-06-05:archive/docs/briefs/Q-DDP-1/sweep_results.csv`) |
...
| A8 | 2026-05-16 | FXIFY-correct timeout semantic. Replaced `portfolio_mc.py`'s 150-bday horizon-runout with 60-bday inactivity bust (matches `firm_rules.py:14`) + 1500-bday safety ceiling. Allocations + dd_protection unchanged from A7. Closes Q-MCTO-1 CLOSED-RESOLVED. **Superseded by A9 on 2026-05-23.** | 99.88% | 0.12% | 4.21% | 21 | +1.10 pp | 0.00 pp | +0.04 pp | [ADR 2026-05-16 FXIFY-correct timeout](../../adr/2026-05-16-fxify-correct-timeout-semantic.md) + [`tests/core/test_mc_anchors.py`](../../../tests/core/test_mc_anchors.py) (pre-2026-05-23 pin) + `Q-MCTO-1-portfolio-mc-timeout-semantics.md` (evicted 2026-06-05; retrieve via `git show pre-prune-2026-06-05:archive/docs/briefs/Q-MCTO-1-portfolio-mc-timeout-semantics.md`) |
| A9 | 2026-05-23 | **Allocation refresh-2 — historical challenge-era calibration + engine regression pin** (re-scoped 2026-07-11; was "current canonical" while FXIFY challenge was live). DJ30 0.75% → 0.70% with Pine pyramid 500% → 750% (CSV `e4dd7` → `237b7`); NAS100 0.45% → 0.37% with Pine pyramid 1000% unchanged (CSV `da880` → `8c850`); Guardian + Aegis date-parity panel refresh only (CSVs `3b689` → `2a704`, `d2682` → `ad2b7`). Wider panel 2022-01-04 → 2026-05-19 (1141 bdays / 227 week-blocks; +102 bdays / +20 week-blocks vs A6-A8 strict 4yr). Supersedes ADR 2026-05-14; carries forward "no version bump" doctrine. | 99.83% | 0.17% | 4.37% | 26 | −0.05 pp | +0.05 pp | +0.16 pp | [ADR 2026-05-23 allocation refresh-2 §Locked MC](../../adr/2026-05-23-allocation-refresh-2.md) + `tests/core/test_mc_anchors.py` (post-ADR pin) |

OANDA pattern-spotting overlay (where exports exist). OANDA reached full 4-strategy parity on 2026-05-24 (added Striker DJ30 v4.5 + Striker NAS100 v1, closing 2026-05-14 ADR §Open items #3); rows dated 2026-05-23 and earlier are the historical 3-strategy DJ30 v4.4 panel:

| Date | OANDA anchor | Pass | Bust | p99 DD | Source |
|------|--------------|-----:|-----:|-------:|--------|
| 2026-05-05 → 2026-05-07 | 3-strategy DJ30 v4.4 at C0 (1.0%/0.40×, 150-bday) | 96.05% | 0.48% | 4.79% | `striker_nas100_q_nas_3_mc_addition.md` §What is NOT in this MC + §Test pin (evicted 2026-06-05; retrieve via `git show pre-prune-2026-06-05:archive/docs/briefs/striker_nas100_q_nas_3_mc_addition.md`) |
| 2026-05-08 → 2026-05-13 | 3-strategy DJ30 v4.4 at C2 (1.5%/0.40×, 150-bday) | 96.23% | 0.69% | 4.91% | [ADR 2026-05-08 §Locked MC](../../adr/2026-05-08-dd-trigger-c2-relock.md) + `tests/core/test_mc_anchors.py` (pre-2026-05-14 pin) |
...
| 2026-05-16 → 2026-05-22 | 3-strategy DJ30 v4.4 at C2, FXIFY-correct semantic, DJ30 0.75% pyr 500% / NAS N/A | 99.51% | 0.49% | 4.82% | [ADR 2026-05-16 §Locked MC](../../adr/2026-05-16-fxify-correct-timeout-semantic.md) + `tests/core/test_mc_anchors.py` (pre-2026-05-23 pin) |
| 2026-05-23 (pre-refresh, superseded) | 3-strategy DJ30 v4.4 at C2, new 2026-05-23 allocations (DJ30 0.70% pyr 750%; OANDA panel 2026-04-25 / 2026-05-08 vintage, no NAS100) | 99.58% | 0.42% | 4.78% | [ADR 2026-05-23 §Locked MC](../../adr/2026-05-23-allocation-refresh-2.md) + `tests/core/test_mc_anchors.py` (pre-2026-05-24 OANDA pin) |
| **2026-05-24 (current)** | **4-strategy** — first OANDA v4.5 DJ30 + v1 NAS100 (G 0.34% / DJ30 v4.5 0.70% pyr 750% / A v4.3 1.50% / NAS v1 0.37% pyr 1000%); 2026-05-24 vintage, **1141 bdays / 227 week-blocks** (Pepperstone panel parity); median 23 d-t-p; bust attribution G 40.0 / DJ30 26.7 / A 17.8 / NAS 15.6 | **99.85%** | **0.15%** | **4.42%** | [core/config/params.toml `[mc_anchor_oanda]`](../../../core/config/params.toml) + [CLAUDE.md §2026-05-23 allocation-refresh-2 MC anchor](../../../CLAUDE.md) + `python portfolio_mc.py --panel oanda` |
...
| A8 — 2026-05-16 FXIFY-correct (superseded by A9) | 40.0% | 8.6% | 37.1% | 14.3% |
| A9 — 2026-05-23 alloc-refresh-2 (historical regression pin) | 41.2% | 19.6% | 37.3% | 2.0% |
...
| A8 (FXIFY-correct — superseded by A9) | ✓ (0.12%) | ✓ (4.21%) — widest margin on record at lock time |
| **A9 (alloc-refresh-2 historical regression pin)** | **✓ (0.17%) — 0.83pp headroom** | **✓ (4.37%) — 0.63pp headroom** |
...
OANDA at O10 (2026-05-24, historical secondary panel — OANDA feed retired 2026-06-24) is a full 4-strategy panel (first v4.5 DJ30 + v1 NAS100 exports) at Pepperstone shape parity (1141 bdays / 227 week-blocks). It clears both (historical) gates at 0.15% bust / 4.42% p99 DD — slightly *tighter* than Pepperstone (0.17% / 4.37%), driven by NAS100 inclusion plus v4.5 DJ30's +17% Net vs Pepperstone (a contract-spec effect, not signal divergence). The prior 3-strategy O8/O9 anchors (DJ30 v4.4, no NAS panel) carried thinner margins (O8 0.49% bust / 4.82% p99 DD; the FXIFY-correct semantic shifted O7 → O8 pass +3.18pp on the same underlying 3-strategy panel). The 2026-05-24 refresh closes 2026-05-14 ADR §Open items #3 (OANDA v4.5 + NAS100 forward consideration). Per the two-tier rule then in force, Pepperstone remains the regression-pin panel and OANDA stays the (now-retired) secondary pattern-spotting proxy.
...
- [ADR 2026-05-16 FXIFY-correct timeout semantic](../../adr/2026-05-16-fxify-correct-timeout-semantic.md) (superseded by 2026-05-23)
- [ADR 2026-05-23 allocation refresh-2](../../adr/2026-05-23-allocation-refresh-2.md) **(historical regression pin; re-scoped 2026-07-11)**
- [ADR 2026-07-11 challenge-era claims rescope](../../adr/2026-07-11-challenge-era-claims-rescope.md) — claim-scope only; pins byte-unchanged
- Q-NAS-3 — 4-strategy MC addition: `striker_nas100_q_nas_3_mc_addition.md` (evicted 2026-06-05; retrieve via `git show pre-prune-2026-06-05:archive/docs/briefs/striker_nas100_q_nas_3_mc_addition.md`)
- Q-DDP-1 — recommendation: `Q-DDP-1/recommendation.md` (evicted 2026-06-05; retrieve via `git show pre-prune-2026-06-05:archive/docs/briefs/Q-DDP-1/recommendation.md`), `Q-DDP-1/sweep_results.csv` (evicted 2026-06-05; retrieve via `git show pre-prune-2026-06-05:archive/docs/briefs/Q-DDP-1/sweep_results.csv`)
- Q-MCTO-1 — portfolio_mc timeout semantics: `Q-MCTO-1-portfolio-mc-timeout-semantics.md` (evicted 2026-06-05; retrieve via `git show pre-prune-2026-06-05:archive/docs/briefs/Q-MCTO-1-portfolio-mc-timeout-semantics.md`) — **CLOSED-RESOLVED 2026-05-16**
- bust_attribution_flip — `bust_attribution_flip.md` (evicted 2026-06-05; retrieve via `git show pre-prune-2026-06-05:archive/docs/briefs/bust_attribution_flip.md`) — closed broker-feed-confirmed 2026-05-08
- [`tests/core/test_mc_anchors.py`](../../../tests/core/test_mc_anchors.py) — engine-regression pins (not live pass-probability)
- [`portfolio_mc.py`](../../../core/portfolio_mc.py) — reproduction harness
