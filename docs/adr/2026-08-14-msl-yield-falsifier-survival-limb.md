...
[MSL charter Gate line](../spec/2026-08-12-msl-manual-sourcing-loop-charter.md) @ `8290b89` 2026-08-13 (quoted verbatim in §2 below) · [plan §6 claim manifest + §7 stop rules](../briefs/2026-08-12-msl-program-plan.md) @ `eb1f7c7` 2026-08-14 · all seven MSL closures (C2/C3/C3-K2/C1/S2A/S2B/S7) + both notices (slate-3, WHO-track) — full list and anchors in [this session's audit note](../notes/audits/programme-audit/2026-08-14-msl-methodology-audit.md) §0.
