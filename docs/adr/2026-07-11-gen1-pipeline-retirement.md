...
**Supersedes:** `2026-06-05-concept-admissibility.md` in part - the `validation/concept_intake/` tree this ADR deleted (machinery only; the doctrine survives per that ADR's own Machinery-status line).
**Supersedes:** `2026-06-05-sweep-engine.md` in part - the `validation/sweep/` tree this ADR deleted (machinery only; the doctrine survives per that ADR's own Machinery-status line).
**Supersedes:** `2026-06-14-rejected-candidate-patterns.md` in part - dedup.py/feedback.py mechanism only. Retires the CFD-era research pipeline that `docs/adr/2026-07-10-databento-research-stack.md` (Gen-2) functionally replaced.
