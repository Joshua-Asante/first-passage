...
**Workflow owners:** [Methodology skills — canonical source, one-way deployment and explicit reviewed releases](../../scripts/README.md#skill-lifecycle) · [Brief authoring — canonical check_brief checker, type contracts and repo subset](../../.claude/skills/brief-authoring/SKILL.md#checker-ownership).
