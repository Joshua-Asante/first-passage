...
**Running counts (canonical, this ADR):** campaigns completed **0** · survivors falsified **0 / 2** · campaigns abandoned **1** (consecutive **1 / 2**) · preregs refused **0** · **active campaign: none** — most recent: **DL-1 ABANDONED 2026-08-16** (train nominee V7 — argmax train net annSR, no fallback per §6 step 2 — failed gates 2a/2b/2d [net annSR −0.42 <0; SPA p=0.94 vs ≤0.10; M-16 slip annSR −0.66]; gate 2c cadence passed; confirm partition MGC.FUT never read per prereg §5 — [`docs/briefs/pre-registration/2026-08-16-deep-lane-dl1-mgc-orc-prereg.md`](../briefs/pre-registration/2026-08-16-deep-lane-dl1-mgc-orc-prereg.md); full per-variant TRAIN results: [`lab/analysis/deep_lane/dl1_mgc_orc_2026-08-16/train_results.json`](../../lab/analysis/deep_lane/dl1_mgc_orc_2026-08-16/train_results.json)). Consecutive abandonments 1/2 — one more triggers the §4(c) audit-report duty.
