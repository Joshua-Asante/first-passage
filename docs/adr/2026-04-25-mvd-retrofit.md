...
**Status:** Accepted - implements the retrofit pass scoped in the MVD discipline ADR (2026-04-24); sanity gate passed (PR #2, all 9 helpers exercised, all 5 reference numbers reproduced).
