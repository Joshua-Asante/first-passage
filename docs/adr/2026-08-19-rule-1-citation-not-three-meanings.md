...
Grounds: cited notice `N-2026-08-18-quintessentials-ml-lifecycle-mapping.md` is **absent** on `origin/main` @ `4a828c7`; gap re-verified independently. Owner texts: Rule 1 archive L19 + L48–92; `mc_anchor_history.md` L3–5; gate L95/L198; Rule 2 ADR L26/§5.8; 2026-08-08 audit §5.
