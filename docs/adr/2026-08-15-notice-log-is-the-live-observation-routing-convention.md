...
- `docs/methodology/strategy_harvest.md:79` — cites `N-2026-07-26-forced-flow-census.md` as the live artifact format for a 2026-07-26 finding, three months after `observation_routing.md`'s claimed replacement date. ⚠ The named Notice is pruned at the Great Prune; retrieve via `git show pre-prune-2026-08-08:docs/notes/notice/N-2026-07-26-forced-flow-census.md`. This Rule-0 line is the 2026-08-15 read, not a claim that the file is still in the working tree.
