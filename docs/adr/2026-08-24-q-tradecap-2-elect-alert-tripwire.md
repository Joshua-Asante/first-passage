...
Grounds: [`Q-TRADECAP-2`](../briefs/Q-TRADECAP-2-per-trade-bound-election.md) · [pre-reg](../briefs/pre-registration/Q-TRADECAP-2-verdict-preregistration.md) @ `4d6761b` · [consult](../notes/notice/N-2026-08-24-ox-alpha-per-trade-bound-election.md) (O4/O5/O6/O7/O9) · operator ratify after Claude review (`961107c` disposed O4/O9).
