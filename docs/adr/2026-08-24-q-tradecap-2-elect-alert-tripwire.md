...
**Status:** `Accepted` — operator ratified 2026-08-24 after Claude judgment review
...
Grounds: [`Q-TRADECAP-2`](../briefs/Q-TRADECAP-2-per-trade-bound-election.md) · [pre-reg](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/docs/briefs/pre-registration/Q-TRADECAP-2-verdict-preregistration.md) @ `4d6761b` · [consult](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/docs/notes/notice/N-2026-08-24-ox-alpha-per-trade-bound-election.md) (O4/O5/O6/O7/O9) · operator ratify after Claude review (`961107c` disposed O4/O9).
...
Gate: `Accepted` — Claude judgment review returned and the operator ratified 2026-08-24. FALSIFIED if any of G1/G2/G3 is already false on those frozen owners (then escalate; do not elect the CFD pair in place).

Boundary: Do not treat this Accepted record as a wire. Do not change `DD_TRIGGER` / `DD_SCALE` / `BASE_RISK`. Do not pass `sl=` or flatten. Do not treat **1-size** as discharging realized loss. Threshold remains a later election. Do not invent a fourth frozen ID.
