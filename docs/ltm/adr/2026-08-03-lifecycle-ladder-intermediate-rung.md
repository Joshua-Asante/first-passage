<!-- relocated from docs/adr/; relative links rewritten 2026-08-22 -->

# ADR 2026-08-03 — Lifecycle ladder: admit an intermediate WATCH-1H rung at 0.40×

**Status:** `Withdrawn` — operator reject 2026-08-22. Own §4 admissibility limb fired: W1 honest-clock both-halves returned 0.50× GATE PASS ([`RESULTS_INTRADAY_W1`](../../../lab/analysis/c1/class_s_c1_haircut_regime_remc_2026-07-16/RESULTS_INTRADAY_W1.md)). No rung landed.
...
**Governed by:** [`2026-07-23-c1-rung-selection-ev-objective.md`](../../adr/2026-07-23-c1-rung-selection-ev-objective.md) (`9ab2e8b`, `Accepted`) — **the ratified rung-selection objective for the already-admitted c1 book.** This ADR operates strictly inside it and does not amend it. See §1 and §3.
**Related:** [`2026-07-17-c1-rail-build-account-registration-go.md`](../../adr/2026-07-17-c1-rail-build-account-registration-go.md) (the GO that deployed c1 at WATCH-1 0.50×) · [`2026-08-03-c1-cadence-leg-preregistration.md`](../../briefs/pre-registration/2026-08-03-c1-cadence-leg-preregistration.md) (sibling artifact from the same measurement) · [`2026-07-13-dd-protection-concept-not-constant.md`](../../adr/2026-07-13-dd-protection-concept-not-constant.md) (the change-control chain any live rung change inherits)
**Layer:** methodology
...
is the output of a ratified selection rule. Under [`2026-07-23-c1-rung-selection-ev-objective.md`](../../adr/2026-07-23-c1-rung-selection-ev-objective.md)
...
| 2026-08-22 | **Operator reject.** Status `Proposed` → `Withdrawn`. §4 admissibility limb fired on W1 0.50× honest-clock PASS. Body relocated to LTM; hot file is the stub. No `core/lifecycle.py` edit. | Joshua (reject) + Cursor (record) |
