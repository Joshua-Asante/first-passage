...
Accepted — 2026-04-25.
Implements the retrofit pass scoped in [`docs/adr/2026-04-24-mvd-discipline.md`](../../adr/2026-04-24-mvd-discipline.md) (Consequences → Cost → "One-time retrofit"). Follows successful sanity gate ([PR #2](https://github.com/Joshua-Asante/prop_firm_pipeline/pull/2): all 9 helpers exercised against canonical Aegis v4.3 panel, all 5 reference numbers reproduced).
...
Retrofit both production files using helpers from [`lib/mvd.py`](../../../core/lib/mvd.py), and append the DD-label finding to the methodology audit table.
...
- Framework ADR: [`docs/adr/2026-04-24-mvd-discipline.md`](../../adr/2026-04-24-mvd-discipline.md)
- Methodology: `docs/methodology/mvd.md` (deleted; MVD methodology retired) (with audit row #10 in this PR)
- Library: [`lib/mvd.py`](../../../core/lib/mvd.py)
