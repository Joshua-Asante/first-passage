...
Note: this is a **scenario override** — `ALLOCATIONS` in [core/portfolio_mc.py](../../core/portfolio_mc.py) and `BASE_RISK` in [core/dd_protection.py](../../core/dd_protection.py) still hold Aegis at 1.50%. Source of truth unchanged.
