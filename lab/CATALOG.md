...
| firm_model_repair_r1_7tier_2026-08-23 | c1 | ACTIVE | yes | W1 pattern extended to all 7 Bulenox/BluSky `dd_type="trailing"` tiers (Q-FIRMEOD-1 successor); all 7 flip CLOCK on direct `simulate_path` diff; no verdict flips on the 2 tiers with a published figure but 1.00x deepens ~7.6x (Bulenox 3.51%→26.77%, BluSky 4.44%→32.26%); 0.50x WATCH-1 both 0.08%→0.59% (still PASS, 2.41pp headroom); 5 tiers carry no published figure to re-measure | lab/analysis/c1/firm_model_repair_r1_7tier_2026-08-23/ | — |
...
| shape_feasibility_map_2026-08 | c1 | ACTIVE | yes | 630-cell region published, Tradeify/MFFU identical; 8/8 corner-case + 3/5 MARGINAL-band validation tuples resolve cle... | lab/analysis/c1/shape_feasibility_map_2026-08/ | — |
