...
| joint_surrogation_null_2026-08-30 | _inbox | ACTIVE | yes | Q-RANGEXFER-1/Q-VOLREGIME-1's joint-surrogation null design (D5 O1): 3 rounds, 7 constructions + 1 gate-redesign attempt + 2 adversarial positive-control re-verification passes, NOT RESOLVED — model adequacy uncertified, Round 3 found the one viable-looking design's Type-I rate empirically 5%→25% once refit per replicate | lab/analysis/_inbox/joint_surrogation_null_2026-08-30/ | — |
