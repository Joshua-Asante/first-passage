...
| tradeify_book_composition_2026-09 | c1 | ACTIVE | yes | informal Downloads-lane measurement, not pre-registered, no K entry; the harness reuses `core/mc/simulation.py` and... | lab/analysis/c1/tradeify_book_composition_2026-09/ | — |
