...
| class_s_w1_bootstrap_honest_2026-09-02 | c1 | ACTIVE | yes | W1 4th partition (honest-clock bootstrap-95th, 0.50x) — INTERIM, operator-stopped at 48/100 panels on 1 of 2 tiers, no gate verdict; honest bust-95th 3.33% vs EOD control 0.68%, paired delta +2.658pp adverse on 48/48 panels; PASSES the live 5.0% ceiling (frozen 08-26, pre-dates this run) on both anchorings with 1.14-1.67pp headroom — larger than the 0.52pp control gap; reproduction check PASSES 6/6 (engine faithful, numpy-drift hypothesis dead) so the earlier "systematic divergence" reading is withdrawn — the control gap re-reads as 48/100 incompleteness on a heavy right tail; quote the conservative published-anchor 3.86% | lab/analysis/c1/class_s_w1_bootstrap_honest_2026-09-02/ | — |
...
| tradeify_book_composition_2026-09 | c1 | ACTIVE | yes | three-leg integer-size book grid (ORB-MNQ recon x ORB-MYM v0.4 x Aegis-6J1) on Select+Growth: NO clear winner, real bust-vs-speed frontier; any leg at qty 2 busts 40-66%; Growth's $3,500 rope is a bigger lever than any composition change; MYM v0.4 hurts every book (+9-11pp bust, joint-loss ratio 1.25 vs MNQ); Aegis x2 ballast improves all three axes but a shuffled-Aegis control matches it => drift, not diversification, and Aegis x2 passes 0.03% on its excluded 2020-22 window. Plus the third-leg shape spec (exact-edge grid: positive net edge non-negotiable, WR >= 85% - 2pp/0.01R at a $200 stop) and the MES MOC-imbalance fade replay on real 1m bars (gross +0.075R, CI spans 0, FAILS the 4x cost-law screen, does not scale with imbalance size; 235 verified-sign sessions) | lab/analysis/c1/tradeify_book_composition_2026-09/ | inputs gitignored |
