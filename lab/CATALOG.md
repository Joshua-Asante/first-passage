...
| todvol_1_2026-08-20 | c1 | ACTIVE | `Q-TODVOL-1` — `tod-baseline-range-trigger` causal G0 freeze (first within-instrument temporal-selectivity candidate since ADR 2026-08-10 route 1 opened); D2 pre-G0 falsifier pending. See [`ops/instruments/MECHANISMS.md`](../../ops/instruments/MECHANISMS.md). | lab/analysis/c1/todvol_1_2026-08-20/ | — |
