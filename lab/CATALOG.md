...
| rangecond_1_2026-08-30 | _inbox | ACTIVE | yes | Q-RANGECOND-1: overnight-range-conditioned ORB-MNQ-1 payoff shape — conditioned WR 66.47% vs unconditioned 41.72% (+24.75pp), mean win +1.571R vs +0.860R (+0.711R), both CIs exclude 0, n_conditioned=340. `RESOLVED`, disclosed panel-vintage caveat (current MNQ_M15.csv is ~300 days shorter than ORB-MNQ-1's original G8 admission panel). Addendum filed on b3-orb-mnq-payability-line.md; full re-MC named as next step | lab/analysis/_inbox/rangecond_1_2026-08-30/ | — |
