# OANDA Stage-1 investigation frozen 2026-06-24 (docs/adr/2026-06-24-oanda-retirement.md). Generic, broker-agnostic helper RETAINED for active importers (e.g. oil_carry, usdcad_rdm) — does not touch the OANDA API.
