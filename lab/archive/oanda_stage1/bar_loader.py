# OANDA retired 2026-06-24 (docs/adr/2026-06-24-oanda-retirement.md) —
# frozen historical artifact; no longer runs because its retired ingestion/data
# dependencies and pre-monorepo `data/bar_data/*.csv` paths were removed.
