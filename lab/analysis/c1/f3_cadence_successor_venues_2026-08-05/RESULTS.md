...
**Status:** ACTIVE — the cadence axis F3 required is measured, and **F3 IS decidable** (corrected 2026-08-26; see banner above). Bulenox and MFFU sit in the same inactivity-death class as Tradeify (90.85–97.54% path death at idle=5) and are eliminated on measured grounds. BluSky's activity rule is **sourced** (ToU art. 11490284 §3.3 + art. 12434442; [Addendum 2026-08-05b](#addendum-2026-08-05b--bluskys-rule-was-sourced-the-limit-is-real-and-the-unit-was-wrong)) — faithful engine limit **22 idle bdays**, corrected exposure **4.87–13.14%**, not the superseded 0.52–1.40%/UNKNOWN read below.
