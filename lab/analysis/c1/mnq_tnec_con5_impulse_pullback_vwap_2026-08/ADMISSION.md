# Q-TNEC-CON-5 — S6 `evaluate_admission` (pre-score)

**Date:** 2026-08-11  
**Input:** [`ADMISSION.json`](ADMISSION.json) · `registered_k=1`  
**Runner:** `$env:PYTHONPATH='lab'; python -c "from discovery.admission_schema import load_admission, evaluate_admission; …"`
