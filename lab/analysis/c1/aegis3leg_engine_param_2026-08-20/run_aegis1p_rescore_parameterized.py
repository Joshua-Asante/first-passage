...
_SCORING = _ROOT / "lab" / "analysis" / "c1" / "geofit_iid_sufficiency_power_2026-08-15"
...
def _parse_aegis_risk(args: list[str], default: float = 0.0100) -> float:
    flag = "--aegis-risk"
    if flag not in args:
        return default
    i = args.index(flag)
...
def main(aegis_risk: float = 0.0100) -> int:
...
if __name__ == "__main__":
    raise SystemExit(main(aegis_risk=_parse_aegis_risk(_ARGS)))
