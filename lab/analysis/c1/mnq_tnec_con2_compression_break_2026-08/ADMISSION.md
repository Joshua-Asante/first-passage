# Q-TNEC-CON-2 — S6 `evaluate_admission` (pre-score)
...
EM3/EM4/EM5 declared true a priori (hard stop G=10, session-flat, independent entries, weekly cadence attainable, RTH slot legal).  
