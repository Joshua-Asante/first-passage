...
| File | Key lines |
|---|---|
| [portfolio_mc.py](../../../core/portfolio_mc.py) | 70-75 (Pepperstone panel paths), 86 (expected symbols), 93 (expected versions), 102-124 (load_trades — only floor `assert_min_rows ≥ 100` + `assert_window ≥ 4yr`, **no per-strategy n_trades hardcode**), 451-458 (`assert_tv_export` identity gate per panel) |
| [lib/mvd.py](../../../core/lib/mvd.py) | 33-43 (`assert_min_rows`), 46-63 (`assert_window`), 139-172 (`assert_tv_export`) |
...
| `striker_nas100_q_nas_3_mc_addition.md` (evicted 2026-06-05; retrieve via `git show pre-prune-2026-06-05:archive/docs/briefs/striker_nas100_q_nas_3_mc_addition.md`) | 41 (independent confirmation: Guardian n=209 in the 4-strategy MC addition brief, 2026-05-05) |
| `2026-05-03_gbpusd_m15_h_lorb_phaseA_abort.md` (evicted 2026-06-05; retrieve via `git show pre-prune-2026-06-05:archive/docs/methodology/archive/gate_audits/2026-05-03_gbpusd_m15_h_lorb_phaseA_abort.md`) | 44 (independent DOW breakdown: Mon 57 + Tue 64 + Thu 88 = 209) |
...
1. Replaced production CSV: 87e73 → 33781 in
   [data/tv_exports/pepperstone/](../../../core/data/tv_exports/pepperstone/), with old
   file deleted.
2. Updated [portfolio_mc.py:71](../../../core/portfolio_mc.py) to point at the new
   filename.
...
4. Updated [data/tv_exports/pepperstone/SHA256SUMS](../../../core/data/tv_exports/pepperstone/SHA256SUMS)
   with the new file's hash.
5. Updated two non-MC analysis scripts that referenced the old filename:
   `archive/analysis/gbpusd_lon/correlation.py:44` (evicted 2026-06-05; retrieve via `git show pre-prune-2026-06-05:archive/analysis/gbpusd_lon/correlation.py`),
   `archive/analysis/eurusd_lnyo/correlation.py:45` (evicted 2026-06-05; retrieve via `git show pre-prune-2026-06-05:archive/analysis/eurusd_lnyo/correlation.py`).
...
- `striker_nas100_q_nas_3_mc_addition.md:41` (evicted 2026-06-05; retrieve via `git show pre-prune-2026-06-05:archive/docs/briefs/striker_nas100_q_nas_3_mc_addition.md`)
...
3. `archive/docs/briefs/striker_nas100_q_nas_3_mc_addition.md` — headline table,
