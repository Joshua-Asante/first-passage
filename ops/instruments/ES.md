...
- **Feed/panel infra is in place:** cost-gated Databento pulls via `.claude/skills/databento-data/scripts/db_fetch.py` (daily-bar chunks estimate ≈ $0); yearly-chunk assembler [`assemble_panels.py`](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/lab/archive/harv_0_month_end_rebalance_es_2026-07/assemble_panels.py) → parquet panels (parents 2010-06→2026-07; micros 2019-05→2026-07). Reusable for any future ES question, subject to W1/W2.
