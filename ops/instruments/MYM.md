...
- **[`overnight-gap-magnitude-range-conditioning` GRADUATE-eligible](../../docs/notes/notice/N-2026-08-29-mym-gap-magnitude-rth-range.md), superseding the same-day HOLD-until-2027-03-01 line (2026-08-29, corrected same day; ruling 2026-08-30).** Same stratified-design correction as the overnight-range sibling — the original marginal "clean kill" (diff −0.1039) inverted sign entirely: within-stratum lift +14.0pp / +6.7pp, bootstrap CI [−4.2pp, +14.8pp] straddling 0, p(lift≤0)=0.1247 / null-calibrated min-lift p=0.0086 (within-stratum enumerated; n_null=1304 vs original n=1307). **Operator ruling, 2026-08-30: "go with INCREMENT, ... the null-calibrated test is the more reliable one"** — the CI's straddle-0 reading is a limitation of a percentile-bootstrap statistic that was never a Type-I-controlled test, not evidence against an increment. Moved DEAD → CONTINGENT-FORWARD → now GRADUATE-eligible. **Nested under `Q-RANGEXFER-1`'s 2026-08-30 amendment as `H-RANGEXFER-1.a-MYM`**, mirroring MNQ's own gap-magnitude sub-question — no separate Pre-Q opening owed; the joint-gate replication (`N-2026-08-29-mym-overnight-gap-joint-gate.md`) confirms this candidate's own weak result nests inside the overnight-range candidate's own gate the same way it does on MNQ (gap adds lift only when overnight range is calm). This day-history-level ruling is distinct from, and does not by itself settle, `H-RANGEXFER-1.a-MYM`'s own overnight-calm-restricted statistic, scored under that brief's own §6.
