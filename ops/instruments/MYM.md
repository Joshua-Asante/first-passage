...
**Status (prior, through 2026-08-03):** **LIVE c1 leg (disarmed).** Hosts the Striker DJ30 v4.5 **venue edition** (`striker_dj30_v4.5_mym.pine`) as one of the two c1 legs on the Tradeify Select 100K eval — `dry_run=true`, WATCH-1 0.50×, **no strategy-signal-originated fill yet** (rail has canned B4 fills: B6 dry-fire 2026-07-20 + 2026-07-27 SIM; account not pristine — see [`AGENTS.md`](../../AGENTS.md) live-execution posture). The **reconstruction** track on this instrument (opening-range *continuation*) is **TERMINAL**.
...
| **M4** | **ORC-01's AMBIGUOUS was the gate working, not a runner bug.** Its exit-2 was the **pre-registered AMBIGUOUS-HOLD branch operating correctly** against a blind spot in the frozen candidate-1 semantic — a universal 16:00 force-flat vs **53 exchange early closes**. Cited correctly: this is a spec blind-spot finding, not a code defect. | [`closure` §3](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/docs/briefs/closures/2026-07-16-striker-mym-reconstruction-candidate-1-ambiguous.md) | **HIGH**. |
| **M5** | **Third-Friday derivative-settlement reversal does not reproduce at useful magnitude.** Native `MYM.v.0` minute data, **$0.00**, exact coverage **84/87 (96.6%) PASS**: overnight **+1.54 bp** (power 0.042), short reversal **+2.68 bp** (power 0.067) — both below the **0.2139** standardized-effect floor; cost-law also FAIL (**+2.68 bp vs 6.57 bp** 4× Tradeify hurdle). Year signs unstable; the tradable limb is **negative in 2024–2026**. | [`mym_3fps_recon_2026-07/RESULTS.md`](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/lab/archive/mym_3fps_recon_2026-07/RESULTS.md) | **HIGH** (native data, pre-registered). |
...
| `S-MYM-ORC-01` — universal-force-flat continuation | AMBIGUOUS-HOLD branch fired: frozen 16:00 force-flat blind to 53 exchange early closes | — | CLOSED-AMBIGUOUS 2026-07-16 — [`closure`](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/docs/briefs/closures/2026-07-16-striker-mym-reconstruction-candidate-1-ambiguous.md) |
| `MYM-3FPS-1` — third-Friday settlement reversal | Both power limbs below the 0.2139 floor **and** cost-law FAIL (2.68 vs 6.57 bp); tradable limb negative 2024–26 | 0 | FALSIFIED 2026-07-21 — [`RESULTS.md`](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/lab/archive/mym_3fps_recon_2026-07/RESULTS.md) |
| `OPENPRESS-1` (MYM limb) — opening-volume × directional efficiency | **Wrong-signed** plus cost FAIL; no threshold/window/instrument rescue licensed | 0 | FALSIFIED 2026-07-21 — [`RESULTS.md`](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/lab/archive/opening_pressure_map_2026-07/RESULTS.md) |
...
- **S3 — order-symbol occupancy (new standing constraint, 2026-07-29).** Any *second* strategy on this instrument in the **same account** shares the `MYM1!` order symbol with the incumbent leg, and the venue holds **one net position per symbol per account**. A second MYM strategy therefore cannot hold an independent position on any day the incumbent can fire (**Tue, Fri**) — **regardless of contract-cap allocation**. This is orthogonal to, and stricter than, the third-leg spec's cap-based Slot framing. Source: [`SLR-MYM-1 closure`](../../docs/briefs/closures/SLR-MYM-1-closure-falsified-stage0.md) F1. ⚠ **Released 2026-08-12** — the incumbent Striker leg has no live venue and cannot fire on any day (2026-08-04 de-scope), and MSL Board B8 explicitly released `MYM1!`/`MNQ1!` occupancy for new non-Striker candidates; see [ADR](../../docs/adr/2026-08-12-msl-mym-occupancy-release.md). Re-binds only if a Striker-shaped leg is ever redeployed here (barred) or occupancy is reserved again by a future ADR.
- **[`overnight-range-day-session-transfer` GRADUATE-eligible, Pre-Q opened 2026-08-30](../../docs/notes/notice/N-2026-08-29-mym-overnight-rth-range-transfer.md) (2026-08-29, corrected same day).** ⚠ **Supersedes the original same-day HOLD-until-2027-03-01 line, struck below.** A design-flaw catch (marginal-rate comparison ≠ "matched conditioning") triggered a stratified re-run: within-stratum lift +31.8pp / +22.1pp, bootstrap CI [+10.4pp, +32.2pp] entirely positive, p=0.00025 / null-calibrated min-lift p=3.4×10⁻⁶ (within-stratum enumerated). D5 stage-1 precondition (2) decisively cleared. Conditions 3 (joint-surrogate null design, adversarial-reviewed) and 4 (operator GO) still outstanding. **Pre-Q authoring, deferred to the planned MNQ+MYM pooling session, is now discharged:** MNQ's own [`Q-RANGEXFER-1`](../../docs/briefs/Q-RANGEXFER-1-overnight-range-gap-magnitude-transfer.md) was amended 2026-08-30 to cover this finding as `H-RANGEXFER-1-MYM`, scored independently of MNQ's own verdict, per the joint-gate replication (below) rather than a fresh separate Q. No raised-bar route needed (conditioner-role, same as candidate 1).
  ...
  ⚠ **Numbers above are stale, corrected 2026-08-31** (`load_sessions.py::overnight_ohlc` scope-gap
  defect, Codex PR #227 follow-up review — see
  ...
  corrected within-stratum lift **+30.6pp / +22.7pp**, bootstrap CI **[+13.3pp, +31.3pp]**,
  null-calibrated min-lift p **3.3×10⁻⁶**. `INCREMENT` verdict, D5 precondition (2) clearance, and
  routing all unchanged — still decisive on both strata.
- **[`overnight-gap-magnitude-range-conditioning` split — `bprime=0` GRADUATE-eligible / `bprime=1` not established](../../docs/notes/notice/N-2026-08-29-mym-gap-magnitude-rth-range.md), superseding the same-day HOLD-until-2027-03-01 line (2026-08-29, corrected same day; ruling 2026-08-30; ruling itself corrected 2026-08-30, Codex review, PR #211).** Same stratified-design correction as the overnight-range sibling — the original marginal "clean kill" (diff −0.1039) inverted sign entirely: within-stratum lift +14.0pp / +6.7pp, bootstrap CI [−4.2pp, +14.8pp] straddling 0, p(lift≤0)=0.1247. **First operator ruling, 2026-08-30: "go with INCREMENT, ... the null-calibrated test is the more reliable one,"** applied to a blended min-lift null-calibrated p=0.0086 — **that figure was itself defective**: `circular_shift_null_min_lift` computes it as the *product* of the two per-stratum tail probabilities, testing the sharp joint null that both strata are simultaneously zero rather than the disjunctive composite null a "both strata" claim needs to reject (Codex review, PR #211). The correct test is an intersection-union test (the *max* of the per-stratum p's), and the per-stratum figures were already on record: **0.00099 (`bprime=0`, decisive)** / **0.152 (`bprime=1`, does not reject)**; max = 0.152, not significant. **Corrected disposition:** the operator's own principle (trust the null-calibrated test) re-applied to the right statistics gives a split result — `bprime=0` (day-history NOT elevated): **INCREMENT**, properly scoped and decisive; `bprime=1` (day-history elevated): **not established**, no GRADUATE routing, no scheduled re-check. Moved DEAD → CONTINGENT-FORWARD → now split as above. **`bprime=0` nested under `Q-RANGEXFER-1`'s new (2026-08-30) hypothesis clause `H-RANGEXFER-1.b-MYM`**, distinct from `H-RANGEXFER-1.a-MYM`'s overnight-calm-restricted claim (a different estimand — see that brief's Estimand-correction note); the joint-gate replication (`N-2026-08-29-mym-overnight-gap-joint-gate.md`) confirms this candidate's own weak pooled result nests inside the overnight-range candidate's own gate the same way it does on MNQ (gap adds lift only when overnight range is calm). Neither this day-history-level split nor `H-RANGEXFER-1.a-MYM`'s own overnight-calm-restricted statistic settles the other — each is scored under `Q-RANGEXFER-1`'s own §6 independently.
- **[`intraday-bar-volume-regime` INCREMENT, precondition cleared](../../docs/notes/notice/N-2026-08-29-mym-bar-volume-regime.md) (2026-08-29, corrected same day; within-stratum null computed 2026-08-30 — corrected a stale restatement of this bullet, Codex review, PR #219).** Same marginal-vs-stratified design flaw as the overnight-range/gap-magnitude pair, caught separately because this construct doesn't cite the D5 spec so the first adversarial pass didn't scan it for the pattern. Stratified on the bar's own already-elevated range: within-stratum lift +16.5pp / +24.5pp, bootstrap CI [+15.4pp, +17.6pp] entirely positive, p≈0. **Within-stratum null-calibrated p computed 2026-08-30 against live `MYM_M15.csv` (vendor bars copied in from the main checkout — the "vendor bars absent" gate this bullet originally cited was a worktree artifact, not a genuine local/remote split): p=0.00025 both strata, decisively clearing alpha.** **Routed INCREMENT** — supersedes this bullet's own original UNRESOLVED disposition (Codex PR #207's own retrofit correctly identified the observed-series CI alone as insufficient; the within-stratum null it called for has since been run and clears). MNQ's independently-run same-day candidate 3 (+22.3pp/+27.4pp post-ToD-fix, also p=0.00025 both strata) corroborates the shape and now shares the identical evidentiary standard. No raised-bar route needed (conditioner-role, same as candidates 1/2). [`Q-VOLREGIME-1`](../../docs/briefs/Q-VOLREGIME-1-intraday-bar-volume-regime.md)'s own Phase 0.5 precondition is CLEARED on both instruments; its own Phase 1 (joint-surrogation attribution) remains the open gate, not this within-stratum test.
...
- **[`bar-closing-location-autocorrelation` DROP](../../docs/notes/notice/N-2026-08-29-mym-closing-location-autocorrelation.md) (2026-08-29, cost-law pre-screen run + disposition 2026-08-30).** SIGNAL-EXCESS (obs −0.0370, CI entirely negative, p=0.005) — admission-route scope resolved by [`2026-08-29 CLV admission-route ADR`](../../docs/adr/2026-08-29-clv-autocorrelation-admission-route-scope.md) (`Accepted`, ratified 2026-08-29, corrected and re-ratified 2026-08-30 — see that ADR's Change history): a bar-shape statistic with no entry rule does not itself trigger the raised bar's gate, and if converted into a construct, Route 1 is plausibly open (independent of Route 3) with Route 2 inapplicable. **DROP (2026-08-30)** — the $0 cost-floor pre-screen ran ([`c5_clv_cost_screen.py`](../../lab/analysis/_inbox/mym_mechanism_harvest_2026-08-29/c5_clv_cost_screen.py)): implied gross edge **+0.36 bp/event**, 95% CI **[+0.24, +0.48]** (real, unlike MNQ's sibling result) but ~18× below #M6's 6.57bp hurdle (provisional, pending F3 re-pricing). Fires ADR §4 D2; no Pre-Q authored. ⚠ Was no longer the batch's largest-magnitude finding by CI tightness/effect size even before this disposition — `intraday-bar-volume-regime`'s corrected +16.5pp/+24.5pp exceeded it — and remains the only *unconditional shape-persistence* result in the batch, now closed.

## RECORD — c1 leg (withdrawn)

- **c1 MYM leg — venue edition, WITHDRAWN from deployment 2026-08-04 (see Status, L4). Record only; nothing here is open.** WATCH-1 0.50×, per-leg cap **69** (⚠ released to 0 2026-08-26 — see [`2026-08-26-striker-legmap-cap-release.md`](../../docs/adr/2026-08-26-striker-legmap-cap-release.md); this RECORD line preserves the pre-release, withdrawal-era figure), expected sizing 8 base / 60 add, hedging rule clears by construction (long-only), disposition fork **F2**. ⚠ **Corrected 2026-08-02 — this line read `9` / `67`, the PRE-2026-07-22 whole-cap values.** At `cap_alloc=69`, `reserve_cap = ⌊69/8.5⌋ = **8**`. Re-pin: [`c1_nt8_sizing_host_impl.md`](../../docs/spec/c1_nt8_sizing_host_impl.md) §7 · synthetic entry `qty=8`. Sweep note lives in the private archive.
...
- **2026-09-02 (later, corrected same day after PR #265 Codex review)** — **Filter screen (3
  FAIL) + independent verification of this ledger's own P50 entry (below) + new `riskBudgetUsd`
  Pine input, engine-tested**
  ...
  scale-in step are OR-width multiples; the Tradeify rope is fixed dollars — 2020-03-20's 560pt
  OR implied $4,200 planned risk at qty 2, more than the whole Select rope) motivated a new
  `riskBudgetUsd` input, pre-registered and engine-scored before being written into the script:
  FAILS the same dominance rule at qty 2. **Per the pre-registration's own rule ("neighbors are
  never promoted over the primary"), that is where this stops** — a qty-1 variant scored better
  in isolation (Select 29.0%→23.9% bust, Growth 19.7%→15.3% bust) but is the observed winner
  among several scored variants, not a licensed recommendation; an earlier pass of this entry
  recommended it as a next-step A/B, which was a genuine rule violation caught in review and
  corrected here, not silently edited away. In practice it is a far-tail 11-of-384-day OR-width
  skip whose own net is positive. Default **OFF** — reproduces every previously-measured number
  in the file's header exactly; a tighter budget measured WORSE (edge concentrates on wide-OR
  days). `python scripts/pine_check.py` (TradingView Guest compile) → `OK`; new Pine SHA-256
  `806619993410e2cdc666dc0e1bc7a1e42dd98ac6fab33dccb1870cbe6cc4e89b`, differing from the
  `9292bd4e…` cited below (this edit postdates every measurement in this entry). K disclosed (§
  counts in the RESULTS doc), not registered via `discovery.register_search` — cumulative
  informal K on this construct family this session ≈35. **Inactivity-barrier check (Codex
  review): every cell here, including the densest (base_q1, 39.7% trade-day density), collapses
  to ~99% total failure via pure inactivity if the standing weekly venue-idle token trade is
  assumed absent — confirmation the mitigation is load-bearing for this whole construct family,
  not a new problem; see
  [[feedback_inactivity_barrier_off_is_correct_weekly_token_trade]].** Source-stage only: no
  Confirm claim, lifecycle/allocation/rail change, or live-capital authorization. No next-step
  A/B is recommended by this entry.
...
- **2026-08-29 (correction, same day)** — **Design-flaw catch on candidates 2/4, from an
  ...
  positive, p=0.00025 / null-calibrated min-lift p=3.4×10⁻⁶) — **DROPPED→HOLD→GRADUATE** (Pre-Q authoring deferred to the planned MNQ+MYM
  ...
  bootstrap CI [−4.2pp,+14.8pp] straddling 0, p=0.1247 / null-calibrated p=0.00860) — **DROPPED→HOLD until 2027-03-01** (verdict unchanged; corrected p flagged separately). Both original
  ...
  ids updated the same way. ⚠ **Candidate #2's own figures above are stale, corrected 2026-08-31**
  (same `overnight_ohlc` scope-gap defect as the bullet above — +30.6pp/+22.7pp, not +31.8pp/+22.1pp;
  `INCREMENT` unchanged). Candidate #4's figures are unaffected (its predictor/restriction never
  touch `on_range`). **Scope-bounded:** candidates 1, 3, and 5 were explicitly out of scope
...
- **2026-08-13 (G0)** — **MSL-C1 G0 FROZEN** ([`PREREG_G0.md`](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/lab/archive/msl_c1_mym_2026-08/PREREG_G0.md)). Operator B4 GO; `K_intrinsic=1`; CONFIRM `2025-09-01→2026-08-13` reserved unread. $0 · K=0.
- **2026-08-13 (Stage-1)** — **MSL-C1 Stage-1 PASS** ([`STAGE1.md`](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/lab/archive/msl_c1_mym_2026-08/STAGE1.md)). After C3 [OPERATOR-KILL](../../docs/briefs/closures/MSL-C3-closure-operator-kill.md); elected existing `pdh-pdl-failed-break-reclaim` on MYM; route ① + B8 occupancy CLEAR; three kill limbs PASS at RT $2.82 / stop 320 pts / 4 contracts ($0.50/pt). No Pine, pull, $0 · K=0.
...
- **2026-08-04b** — **Cross-reference: MYM's own measured 0.49R edge included in the slow-archetype eval-time-limit study (MNQ.md N13).** Tradeify's Select 100K eval confirmed to have no time limit (verified in-browser, three primary sources). At k=1 (independent), safely sized to the rope, MYM's edge produces a **46-day median pass at 0.8% bust** and clears the $200 funded floor. Weaker than MNQ's 0.85R row (21 days) but not disqualifying — the constraint MYM actually failed in the funded-phase de-scope (pyramid-dependent, >40-micro days) is untouched by this study, which is flat-sized. $0/K=0. [`RESULTS`](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/lab/analysis/c1/eval_slow_archetype_2026-08-04/RESULTS.md)
...
## 2026-09-10 - M1 test-only identity

`m1_stage1_test` is the user-approved offline Stage 1 proof identity on MYM/`MYM1!`,
entry-only, cap one micro and permanently dry-run-only. Its smallest valid tuple
