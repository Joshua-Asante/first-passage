...
- **2026-08-29 (correction, same day)** — **Design-flaw catch on candidates 2/4, from an
  ...
  positive, p=0.00025 / null-calibrated p=0.00025) — **DROPPED→HOLD→GRADUATE** (Pre-Q authoring deferred to the planned MNQ+MYM
  ...
  bootstrap CI [−4.2pp,+14.8pp] straddling 0, p=0.1247 / null-calibrated p=0.0117) — **DROPPED→HOLD until 2027-03-01** (verdict unchanged; corrected p flagged separately). Both original
