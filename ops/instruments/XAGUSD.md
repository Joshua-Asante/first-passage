...
| **F3** | **Silver amplifies H1 (2020–2023) co-drawdown under decompounded MC** when inserted as a 5th Guardian-family leg — 2020–2021 Silver cohort net-negative; H1 bust rises sharply vs 4-strat baseline. Compounded 2022–26 can look Pareto-clean at low risk — that flattery does not survive the hard half. | [`lab/analysis/legacy/silver_regime_2026-06-10/RESULTS.md`](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/lab/analysis/legacy/silver_regime_2026-06-10/RESULTS.md) | **HIGH** (MC characterization) |
