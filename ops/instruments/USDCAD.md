...
- **Wording amendment:** landed as Amendment A1 in the pre-reg ([`docs/ltm/briefs/pre-registration/FWD-PREREG-BPC-USDCAD-TUE-2026-06-11.md`](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/docs/ltm/briefs/pre-registration/FWD-PREREG-BPC-USDCAD-TUE-2026-06-11.md)), dated 2026-06-11 — before any forward data exists (first eligible trade 2026-06-16), so checkpoints remain clean under the pre-reg's own audit hook.
...
6. **BoC decision-day array 2022–2026** verified **2022–2026** vs bankofcanada.ca (**2022 gap closed 2026-06-15**: 8 dates, all 10:00 ET, confirmed vs BoC FAD press releases). Announcement time **10:00 ET through 2023 (last: Dec 6 2023) → 09:45 ET from Jan 24 2024** (presser ~10:30; change announced Dec 2023 re: FX-option-expiry timing). Lives in bpc_usdcad_v0_1.pine (**blocks OFF for the Tue-only forward test**); extend yearly. Full verified array → [`lab/archive/usdcad_ratemap_verify_2026-06-15/RESULTS.md`](https://github.com/Joshua-Asante/first-passage-archive/blob/5d47b4dc5fd20da5e93edfed2f6eafd0d4a6ddd2/lab/archive/usdcad_ratemap_verify_2026-06-15/RESULTS.md).
