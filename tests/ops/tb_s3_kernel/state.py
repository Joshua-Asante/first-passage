...
@dataclass
class UnownedRequest:
    """An external request has no inferred payload; its completion requires account coverage."""

    request_id: str
    symbols: set[str] = field(default_factory=set)
    status: str = "pending"  # pending | covering | resolved | conflict
