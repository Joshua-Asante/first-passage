...
# (docs/adr/2026-08-26-striker-legmap-cap-release.md); this listener suite
# tests handle_signal's routing logic (submit/halt/dry-run semantics), not
# whether Striker currently holds live cap, so it pins the historical split
