...
def test_offsetting_pnls_count_as_trading_day_for_phase_completion():
    """Any execution day counts, even when strategy P&Ls net to exactly zero."""
    path = _build_path(
        [
            [100.0, -100.0, 0.0, 0.0],
    ...
    outcome, day, _, _ = _simulate_path(
        path,
        DD_TRIGGER,
        DD_SCALE,
        horizon=2,
