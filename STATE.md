...
|---|---|---|---|
| 0 | ⏳ **Activity-week coverage — RECURRENCE UNRULED.** No standing weekly licence (compliance limb 5 = one named week; S1 only constrains *who* may place). Each further week = fresh operator decision. **Operator-placed at venue — not the rail** (no agent). Idle-clock observer booked under §Scheduled forward triggers → *Weekly — recurring* (radar reads it). Detail / "R8" misnomer correction stay with owners | [`compliance §2a`](docs/notes/rail_build/TRADEIFY_AUTOMATION_PAYOUT_COMPLIANCE.md) · [`S1`](docs/adr/2026-08-07-loop-s1-environment-ratification.md) · [idle-clock spec](docs/superpowers/specs/2026-08-02-idle-clock-tracking-spec.md) · [audit FU-1](docs/notes/audits/programme-audit/2026-08-05-post-descope-claim-alignment-audit.md) | keeps the account alive; unrecoverable if missed |
...
- **2026-08-14** — **MSL slate-3 `BLOCKED` (mechanism-dry).** Board-lite constraints frozen; no fade WHO outside 2026-08-10 INTAKE-DRY; camp not scaffolded; functional 3/3. $0/K=0. [`notice`](docs/notes/notice/N-2026-08-14-msl-slate-3-constraints.md)
...
- **2026-08-13** — **`implied_annualized_sr` DEMOTED gate → report-only (`IMPLIED-SR-REPORT-ONLY-2026-08-13`); Tradeify-native fade design-region REOPENED as geometry.** 1.83 is a cohort disclosure, not a FAIL. Measured-edge still gates on DSR-at-K. No mechanism admitted. $0/K=0. [`ADR`](docs/adr/2026-08-13-implied-sr-report-only-fade-reopen.md) · [Ruling 5 reversal](docs/notes/2026-07-31-fade-stage1-frozen-rulings.md)
...
- **Venue idle-clock — ≥1 operator-placed trade per Mon–Fri week on the live account (identifier
  ...
  **Roll this date forward each Monday.** Booked here 2026-08-09 *specifically so the existing
  ...
  it. [`compliance §2a`](docs/notes/rail_build/TRADEIFY_AUTOMATION_PAYOUT_COMPLIANCE.md) ·
  [`idle-clock spec`](docs/superpowers/specs/2026-08-02-idle-clock-tracking-spec.md)
...
- **Per-fill add-slippage capture (B7 Stage 2b)** — waits first strategy-signal **add** fill; prerequisite ledger price-capture landed. [`RUNBOOK §B7`](docs/notes/rail_build/RUNBOOK.md) · [`Q-COSTGEO-3`](docs/briefs/closures/Q-COSTGEO-3-closure-ambiguous-needs-depth.md)
- **Forward regime monitor / decompound limb-2 successor** — ORPHANED same hole: CFD limb-2 cannot fire; venue-native design landed (not ratified); gated on first live fill. [`design`](docs/superpowers/specs/2026-08-02-venue-native-regime-monitor-design.md) · [`decompound ADR §Addendum 2026-08-03`](docs/adr/2026-06-07-decompound-remc-hold.md) · [`Pepperstone retirement`](docs/adr/2026-08-02-pepperstone-feed-retirement.md)
- **CFD data-estate class-wide delete** — trigger-dated; blocked on T1 (F3 FUTURES_LOCK) + substrate Phase-6 confirm. [`notice`](docs/notes/notice/N-2026-07-17-cfd-data-estate-trigger-dated-disposition.md)
- **Mechanism-sourcing radar** — on-demand cadence; 08-08/11-08 = progress/idle checkpoints; idle guard 2026-11-08. [`design`](docs/superpowers/specs/2026-07-16-mechanism-sourcing-strategy-design.md)
