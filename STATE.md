...
- **2026-09-11** — Production market-data feed ruled: personal live Tradovate data-only account (option A′) selected as leader; funding gated on a readiness checkpoint after written vendor verification (Track A plan §3.2); adapter owed (Track A A9); no feed connected; no arm. [S2b build ADR §2 row + Addendum](docs/adr/2026-08-08-s2b-signal-daemon-build.md#addendum-2026-09-11--stage-1-input-source-options-and-ratified-selection-option-d)
