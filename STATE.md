...
- **Reversed-evidence docs sweep (follow-up owed)** — the 2026-08-31 audit was a targeted 39-file pass (known-reversal-event propagation, not a blind full-corpus scan) and fixed all 34 confirmed findings; it explicitly left `ops/instruments/*.md` (32 files), 36 of 41 `docs/pursuits/*.md`, `docs/personas/*.md` (22), 21 of 23 `.claude/skills/*/SKILL.md`, and most `core/strategies/**/*.md` card mirrors unswept for this failure class. On-demand cadence, no forced date. [`audit note`](docs/notes/audits/2026-08-31-reversed-evidence-docs-audit.md)
