...
- **Reversed-evidence docs sweep (follow-up owed)** — three 2026-08-31 audits, same targeted (known-reversal-event propagation, not blind full-corpus) method, all merged: the original 39-file mirror-docs pass (34 confirmed findings, [`audit note`](docs/notes/audits/2026-08-31-reversed-evidence-docs-audit.md)); `ops/instruments/*.md` (32 files, 38 confirmed findings, [`audit note`](docs/notes/audits/2026-08-31-ops-instruments-reversed-evidence-audit.md)); and `docs/pursuits/*.md` (41 files) + `docs/personas/*.md` (34 incl. archive) (16 confirmed findings, [`audit note`](docs/notes/audits/2026-08-31-pursuits-personas-reversed-evidence-audit.md)). Still unswept for this failure class: 21 of 23 `.claude/skills/*/SKILL.md`, and most `core/strategies/**/*.md` card mirrors. On-demand cadence, no forced date.
