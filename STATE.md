...
| 3 | **SSOT/data-lineage remediation, Phase 2** — A8 intra-ADR running-count consistency (`check_adr_graph`). Phase 1 landed PR #178. No STATE/MNQ join; no HTML-comment schema. Phases 3–4 stay named-not-scoped | [`ADR addendum`](docs/adr/2026-08-27-ssot-data-lineage-remediation-program.md#addendum-2026-08-29--phase-2-authorized-a8-intra-adr-running-count-consistency) · [`Phase 2 plan`](docs/superpowers/plans/2026-08-29-ssot-phase-2-running-count-mirror.md) | none — governance/tooling, independent of #1/#2 |
