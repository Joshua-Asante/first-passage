...
- **Deep-iteration lane — geometric-feasibility-ratio audit owed before DL-3.** DL-2 abandoned 2026-08-22 (2nd consecutive after DL-1) on catastrophic force-flat/non-resolution dominance (85–95% of trades, reference-window-derived stop/target too wide for a single-session hold). No successor prereg reusing that construction may freeze without first computing and disclosing the ratio of reachable within-session price movement to the reference-window width, for its own target instrument (diagnostic only — no OUTER-investigation slot consumed, no confirm touched). DL-1's own abandonment is a separate, candidate-level failure (reconciled 2026-08-22) and does NOT corroborate a shared template defect. [`DL-2 Iterate block`](lab/archive/dl2_m6a_pdhpdl_2026-08-22/RESULTS.md) · [`DL-1 Iterate block`](lab/archive/dl1_mgc_orc_2026-08-16/RESULTS.md) · [`charter`](docs/adr/2026-08-16-deep-iteration-lane-charter.md)
