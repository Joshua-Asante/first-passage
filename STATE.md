...
| 2 | **Per-trade dollar-loss bound — ratify ID 2 tripwire** (`Proposed` light ADR; Q still `OPEN`) | [`2026-08-24-q-tradecap-2-elect-alert-tripwire.md`](docs/adr/2026-08-24-q-tradecap-2-elect-alert-tripwire.md) · [`Q-TRADECAP-2`](docs/briefs/Q-TRADECAP-2-per-trade-bound-election.md) · [consult](docs/notes/notice/N-2026-08-24-ox-alpha-per-trade-bound-election.md) | any future arming session carries the gap unresolved until `Accepted` |
