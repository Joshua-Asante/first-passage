...
|---|---|---|---|
| 1 | **Tradeify Select configuration campaign** — Codex orchestrates one bounded attempt. Complete export-bound inputs, private account binding, synchronized replay and the statistical freeze. S1/S2 approved. Scanner deferred; no qualified book or live authorization. | [`campaign state §50`](docs/briefs/programs/2026-09-03-seven-strategy-select-campaign-state.md#50--used-account-kernel-2026-09-05) · [`current plan`](docs/superpowers/plans/2026-09-02-seven-strategy-tradeify-select-configuration.md) | Frozen search and winner validation |
