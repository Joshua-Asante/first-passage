...
| 2 | **Per-trade dollar-loss bound — elect among frozen closes** (Q-TRADECAP-1 `RESOLVED`: no bound exists). Successor [`Q-TRADECAP-2`](docs/briefs/Q-TRADECAP-2-per-trade-bound-election.md) Phase 0: CFD 2.0% is 66.7% of the $3,000 trail; no daily-loss rule; `sl=` unpaid. Option 1-as-staged not startable | [`Q-TRADECAP-2`](docs/briefs/Q-TRADECAP-2-per-trade-bound-election.md) · [pre-reg](docs/briefs/pre-registration/Q-TRADECAP-2-verdict-preregistration.md) · [`Q-TRADECAP-1 closure`](docs/briefs/closures/Q-TRADECAP-1-closure-resolved.md) | any future arming session carries the gap unresolved |
