...
- **Deep-iteration lane — §4(c) supply-side audit DELIVERED 2026-08-23 (`AMBIGUOUS`); its named nearest supply lead, `MNQFLOW-1-DEPTH`, was signed the same day and then BLOCKED AT ITS OWN COST GATE — operator decision owed on how the lane proceeds, not just whether to pull.** The audit ([note](docs/notes/audits/programme-audit/2026-08-23-deep-lane-supply-audit.md)) found no candidate family simultaneously genuinely-new-mechanism, reachable with current data, and venue-shape-compatible, naming `MNQFLOW-1-DEPTH` (order-flow) as the nearest satisfier, "one sign-off away." **That characterization is now stale.** The operator signed same-day; the frozen P0 re-estimate on the actual 30 pre-registered calendar days came back **$148.04 against a $125.00 ceiling (18.4% over)** — aborted before any pull, $0 spent, per [the prereg's own §9.2](lab/analysis/c1/mnq_orb_flow_depth_2026-08-18/PREREG.md). Three named paths, none elected: raise the ceiling (confirm the Avenue-A credit actually extends that far first), a fresh S2 sample under its own new pre-registration (this one is now cost-contaminated, can't be resampled in place), or decline. The free alternate (a published MOC-imbalance cohort δ) and the blind channel (unsourced, 1/3) remain the other two named supply routes. Re-test / 2026-11-08 slate logic from the audit is unchanged. Background: DL-2's construction retired for M6A (geometric-feasibility diagnostic, median R=1.0/0.687, 85–97% of fired trades never reach 1R); DL-1 is a separate candidate-level failure — no shared template defect. [`DL-2 Iterate block`](lab/archive/dl2_m6a_pdhpdl_2026-08-22/RESULTS.md) · [`charter`](docs/adr/2026-08-16-deep-iteration-lane-charter.md)
