...
**Source disposition (2026-09-11):** Databento retired/unsubscribed by operator report ([owner record](docs/adr/2026-07-10-databento-research-stack.md#addendum-2026-09-10---operator-retirement-of-databento)); no live feed approved. The Stage 1 input is an **operator-attended controlled input**, ratified 2026-09-11 as the explicit acceptance amendment ([S2b build ADR Addendum 2026-09-11](docs/adr/2026-08-08-s2b-signal-daemon-build.md#addendum-2026-09-11--stage-1-input-source-options-and-ratified-selection-option-d) option D · [M1 ADR Addendum 2026-09-11](docs/adr/2026-07-22-c1-venue-native-monitoring-maturity.md#addendum-2026-09-11--item-5-input-for-stage-1-operator-attended-controlled-input-express)). The attended ceremony (A7) succeeded and the signed M1 acceptance is deployed; A8 pin-record re-bake and closeout remain owed, with evidence linked from queue item 1; live-feed readiness remains separate and owed; no arm. **Production feed deferred 2026-09-11 (Track B open item O-4):** no provider is selected, funded or connected; option A′ is shortlisted only. Provider-neutral preparation may proceed, but provider-specific implementation and spend wait until the fixed book clears every source-independent gate and the operator returns for the funding decision.

| # | Item | Owner artifact | Blocks |
|---|---|---|---|
| 1 | **B7-REFIRE Stage 1 + M1 — M1 RESOLVED in-repo; listener re-bake owed (A8 Step 2.4b).** Signed acceptance deployed disarmed as v10; the refreshed pin record must be merged and re-baked before this item leaves the queue. No arm. | [A8 deployment record](docs/notes/rail_build/M1_STAGE1_DEPLOYMENT_READINESS.md#a8--signed-acceptance-deployed-pin-record-re-bake-owed-2026-09-14) · [Track A plan](docs/superpowers/plans/2026-09-10-track-a-m1-stage1-completion.md) | Live-signal / arming path |
| 2 | **Track B — qualify the accepted Tradeify book** — K=1 confirmation of the operator-accepted four-strategy book under the fixed 1% trigger / 40% scale / full ORB base / ORB adds-off policy; HOLD released 2026-09-11 for the umbrella's packets only (TB-G0, D-B1..D-B15 recorded); wave 1a dispatchable, later waves per the umbrella's wave gates. Consumes Track A's M1 `RESOLVED`; the production feed for the four adapters is a separate open operator decision (umbrella O-4). The operator's name for this book is the **Tradeify portfolio**. Coordinator dispatch 1 (2026-09-12): #356 credited (ports, candidate policy code, emulator, captured-size parity PASS); TB-R2 export menu ([note](docs/notes/2026-09-12-track-b-scaling-faithfulness-read.md)) and TB-W1 landed; TB-T1 packet READY (not launched); O-1 and O-5..O-9 **ruled 2026-09-12 (defaults)**, menu FROZEN (7 owed exports, operator); TB-S2 merged; TB-S3 #360, TB-P2 #361, TB-O1 #362, TB-P1 #363 and executable-model #365 are under Astra closeout; TB-S1 contract authored. Exact observed heads, remaining ratifications and bounded TB-I1/I2/I3/T1 packets are in the [closeout](docs/briefs/handoffs/2026-09-13-tradeify-contract-closeout.md). Claude/Fable are historical authors only, not active dependencies. No deployment or arm authority. | [Track B umbrella](docs/briefs/handoffs/2026-09-10-track-b-qualify-accepted-book-umbrella.md) · [campaign record §55](docs/briefs/programs/2026-09-03-seven-strategy-select-campaign-state.md#55--track-b-release--d-b1d-b15-recorded-2026-09-11) · [acceptance](docs/notes/2026-09-10-tradeify-protection-selection.md) · [dispatch 1](docs/notes/2026-09-12-tradeify-portfolio-coordinator-dispatch-1.md) | Deployment GO / arm |

**Campaign owner:** Astra coordinates both Tradeify tracks and owns implementation and evidence assessment under the [operator ownership direction](docs/briefs/programs/2026-09-03-seven-strategy-select-campaign-state.md#57--astra-tradeify-contract-ownership-and-closeout-routing-2026-09-13). Joshua retains ratifications, merges and operational GOs.
