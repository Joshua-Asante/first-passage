...
- **2026-09-23** — T00 step-1 return accepted (INSUFFICIENT). Condition 4 ruled **no**: a T00 screen is not four-firm §4 falsifier evidence, so the 2026-11-08 falsifier needs its own dated re-MC regardless of T00. The operator intends to ratify a timing convention for the qualification replay; none is ratified yet. No step 2, screen, MC, provider or spend is granted. [T00 rulings](docs/briefs/handoffs/2026-09-22-tradeify-t00-step1-producer-inventory.md#78-operator-rulings-on-the-return-2026-09-23)
