...
|---|---|---|---|
| 1 | **Tradeify Select configuration campaign** — Codex orchestrates one bounded attempt. Complete export-bound inputs; settle speed population and final-validation timing before freeze. Scanner deferred; no qualified book or live authorization. | [`campaign state §49`](docs/briefs/programs/2026-09-03-seven-strategy-select-campaign-state.md#49--codex-takeover-and-bounded-campaign-revision-2026-09-05) · [`current plan`](docs/superpowers/plans/2026-09-02-seven-strategy-tradeify-select-configuration.md) | Frozen search and winner validation |
